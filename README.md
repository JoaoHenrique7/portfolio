...
No desenvolvimento desse projeto, utilizamos o framework de trabalho baseado na metodologia ágil Scrum. As funções desempenhadas foram as seguintes: Scrum Master, Product Owner e Equipe de Desenvolvimento. Contribuí atuando como Desenvolvedor na equipe de desenvolvimento. Para desempenhar essa função da melhor maneira possível, contei com o auxílio do Product Owner para transformar os requisitos do cliente em atividades a serem realizadas, e também do Scrum Master para gerenciar datas e o progresso das sprints.

Na fase de desenvolvimento propriamente dita, durante a primeira sprint, a prioridade foi entregar um MVP (Minimum Viable Product) para o cliente, algo que já pudesse demonstrar valor para ele. Minha responsabilidade foi criar os menus do sistema e ajudar o restante da equipe a estruturar o código inicial para que a aplicação web pudesse rodar. Além disso, em paralelo, contribuí para a extração de dados, que era o grande problema a ser solucionado. Essa extração foi realizada por meio de uma técnica de raspagem de dados utilizando Python, conhecida como "web crawler".
